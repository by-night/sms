<template>
  <div>
    ...
    <el-row>
      <el-col :span="6" class="divBlock block_a"></el-col>
      <el-col :span="6" class="divBlock block_b"></el-col>
      <el-col :span="6" class="divBlock block_c"></el-col>
      <el-col :span="6" class="divBlock block_d"></el-col>
    </el-row>
  </div>
</template>
...
<style scoped>
  ...
  .block_a {
    background: url('../../assets/bg_a.png') center no-repeat;
    background-size: cover;
  }
  .block_b {
    background: url('../../assets/bg_b.png') center no-repeat;
    background-size: cover;
  }
  .block_c {
    background: url('../../assets/bg_c.png') center no-repeat;
    background-size: cover;
  }
  .block_d {
    background: url('../../assets/bg_d.png') center no-repeat;
    background-size: cover;
  }
</style>
<style>
